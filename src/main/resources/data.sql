...
values  ('OPEN', 1, 1,'Java in action', 'Urma R.-G., Fusco M., Mycroft A.', 1, 2, '1', 1),
        ...
        ('OPEN', 1, 4,'Sherlock Holmes', 'Arthur Conan Doyle', 2, 3, '4', null),
        ('OPEN', 1, 5,'Harry Potter and the Philosopher\'s stone', 'J. K. Rowling', null, 4, '5', null),
        ('OPEN', 1, 6,'1984', 'George Orwell', 3, 5, '9780451524935', null),
        ('OPEN', 1, 7,'To Kill a Mockingbird', 'Harper Lee', 4, 7, '9780061120084', null),
        ('OPEN', 1, 8,'Pride and Prejudice', 'Jane Austen', null, 3, '9781503290563', null),
        ('OPEN', 1, 9,'The Great Gatsby', 'F. Scott Fitzgerald', 4, 4, '9780743273565', null),
        ('OPEN', 1, 10,'Moby Dick', 'Herman Melville', null, 2, '9781503280786', null),
        ('OPEN', 1, 11,'War and Peace', 'Leo Tolstoy', 4, 6, '9780199232765', null),
        ('OPEN', 1, 12,'The Catcher in the Rye', 'J.D. Salinger', 4, 5, '9780316769488', null),
        ('OPEN', 1, 13,'The Odyssey', 'Homer', null, 10, '9780140268867', null),
        ('OPEN', 1, 14,'The Divine Comedy', 'Dante Alighieri', null, 4, '9780142437223', null),
        ('OPEN', 1, 15,'Jane Eyre', 'Charlotte Brontë', null, 3, '9781503278196', null),
        ('OPEN', 1, 16,'Wuthering Heights', 'Emily Brontë', 4, 4, '9780141439556', null),
        ('OPEN', 1, 17,'Brave New World', 'Aldous Huxley', 3, 7, '9780060850524', null),
        ('OPEN', 1, 18,'Madame Bovary', 'Gustave Flaubert', 4, 5, '9780140449129', null),
        ('OPEN', 1, 19,'One Hundred Years of Solitude', 'Gabriel Garcia Marquez', null, 8, '9780060883287', null),
        ('OPEN', 1, 20,'In Search of Lost Time', 'Marcel Proust', null, 2, '9780143039570', null),
        ('OPEN', 1, 21,'Ulysses', 'James Joyce', null, 3, '9780199535675', null),
        ('OPEN', 1, 22,'Don Quixote', 'Miguel de Cervantes', null, 7, '9780060934347', null),
        ('OPEN', 1, 23,'The Iliad', 'Homer', null, 5, '9780140275360', null),
        ('OPEN', 1, 24,'The Hobbit', 'J.R.R. Tolkien', null, 9, '9780345339683', null),
        ('OPEN', 1, 25,'Fahrenheit 451', 'Ray Bradbury', 3, 4, '9781451673319', null);
