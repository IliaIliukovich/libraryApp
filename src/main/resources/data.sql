...
insert into book (id, title, author, category_id, available_amount, isbn, book_detail_id)
    values  (1,'Java in action', 'Urma R.-G., Fusco M., Mycroft A.', 1, 2, '1', 1),
            ...
            (4, 'Sherlock Holmes', 'Arthur Conan Doyle', 2, 3, '4', 4),
            (5,'Harry Potter and the Philosopher\'s stone', 'J. K. Rowling', null, 4, '5', 5),
            (6,'1984', 'George Orwell', 3, 5, '9780451524935', 6),
            (7,'To Kill a Mockingbird', 'Harper Lee', 4, 7, '9780061120084', 7),
            (8,'Pride and Prejudice', 'Jane Austen', null, 3, '9781503290563', 8),
            (9,'The Great Gatsby', 'F. Scott Fitzgerald', 4, 4, '9780743273565', 9),
            (10,'Moby Dick', 'Herman Melville', null, 2, '9781503280786', 10),
            (11,'War and Peace', 'Leo Tolstoy', 4, 6, '9780199232765', 11),
            (12,'The Catcher in the Rye', 'J.D. Salinger', 4, 5, '9780316769488', 12),
            (13,'The Odyssey', 'Homer', null, 10, '9780140268867', 13),
            (14,'The Divine Comedy', 'Dante Alighieri', null, 4, '9780142437223', 14),
            (15,'Jane Eyre', 'Charlotte Brontë', null, 3, '9781503278196', 15),
            (16,'Wuthering Heights', 'Emily Brontë', 4, 4, '9780141439556', 16),
            (17,'Brave New World', 'Aldous Huxley', 3, 7, '9780060850524', 17),
            (18,'Madame Bovary', 'Gustave Flaubert', 4, 5, '9780140449129', 18),
            (19,'One Hundred Years of Solitude', 'Gabriel Garcia Marquez', null, 8, '9780060883287', 19),
            (20,'In Search of Lost Time', 'Marcel Proust', null, 2, '9780143039570', 20),
            (21,'Ulysses', 'James Joyce', null, 3, '9780199535675', 21),
            (22,'Don Quixote', 'Miguel de Cervantes', null, 7, '9780060934347', 22),
            (23,'The Iliad', 'Homer', null, 5, '9780140275360', 23),
            (24,'The Hobbit', 'J.R.R. Tolkien', null, 9, '9780345339683', 24),
            (25,'Fahrenheit 451', 'Ray Bradbury', 3, 4, '9781451673319', 25);
