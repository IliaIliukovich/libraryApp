...
insert into buildings (id, name, address, has_reading_room)
...
insert into book (id, title, author, category_id, available_amount, isbn, book_detail_id, building_id)
values  (1,'Java in action', 'Urma R.-G., Fusco M., Mycroft A.', 1, 2, '1', 1, 1),
        (2,'Algorithms', 'Robert Sedgewick, Kevin Wayne', 1, 1, '2', 2, 3),
        (3,'Design Patterns', 'Erich Gamma, Richard Helm, Ralph Johnson, and John Vlissides', 1, 4, '3', 3, 5),
        (4,'Sherlock Holmes', 'Arthur Conan Doyle', 2, 3, '4', null, 4),
        (5,'Harry Potter and the Philosopher\'s stone', 'J. K. Rowling', null, 4, '5', null, 6),
        (6,'1984', 'George Orwell', 3, 5, '9780451524935', null, 1),
        (7,'To Kill a Mockingbird', 'Harper Lee', 4, 7, '9780061120084', null, 3),
        (8,'Pride and Prejudice', 'Jane Austen', null, 3, '9781503290563', null, 6),
        (9,'The Great Gatsby', 'F. Scott Fitzgerald', 4, 4, '9780743273565', null, 2),
        (10,'Moby Dick', 'Herman Melville', null, 2, '9781503280786', null, 3),
        (11,'War and Peace', 'Leo Tolstoy', 4, 6, '9780199232765', null, 1),
        (12,'The Catcher in the Rye', 'J.D. Salinger', 4, 5, '9780316769488', null, 4),
        (13,'The Odyssey', 'Homer', null, 10, '9780140268867', null, 4),
        (14,'The Divine Comedy', 'Dante Alighieri', null, 4, '9780142437223', null, 5),
        (15,'Jane Eyre', 'Charlotte Brontë', null, 3, '9781503278196', null, 2),
        (16,'Wuthering Heights', 'Emily Brontë', 4, 4, '9780141439556', null, 1),
        (17,'Brave New World', 'Aldous Huxley', 3, 7, '9780060850524', null. 5),
        (18,'Madame Bovary', 'Gustave Flaubert', 4, 5, '9780140449129', null. 3),
        (19,'One Hundred Years of Solitude', 'Gabriel Garcia Marquez', null, 8, '9780060883287', null, 1),
        (20,'In Search of Lost Time', 'Marcel Proust', null, 2, '9780143039570', null, 2),
        (21,'Ulysses', 'James Joyce', null, 3, '9780199535675', null, 2),
        (22,'Don Quixote', 'Miguel de Cervantes', null, 7, '9780060934347', null, 4),
        (23,'The Iliad', 'Homer', null, 5, '9780140275360', null, 3,
        (24,'The Hobbit', 'J.R.R. Tolkien', null, 9, '9780345339683', null, 4),
        (25,'Fahrenheit 451', 'Ray Bradbury', 3, 4, '9781451673319', null, 1);
