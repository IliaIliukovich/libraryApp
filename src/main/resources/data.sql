...
insert into book (access_level, building_id, id, title, author, category_id, available_amount, isbn, book_detail_id)
values ('OPEN', 1, 1, 'Java in action', 'Urma R.-G., Fusco M., Mycroft A.', 1, 2, '1', 1),
       ('OPEN', 1, 2, 'Algorithms', 'Robert Sedgewick, Kevin Wayne', 1, 1, '2', 2),
       ('OPEN', 1, 3, 'Design Patterns', 'Erich Gamma, Richard Helm, Ralph Johnson, and John Vlissides', 1, 4, '3', 3),
       ('OPEN', 1, 4, 'Sherlock Holmes', 'Arthur Conan Doyle', 2, 3, '4', 4),
       ('OPEN', 1, 5, 'Harry Potter and the Philosopher\'s stone', 'J. K. Rowling', null, 4, '5', 5),
        ('OPEN', 1, 6,'1984', 'George Orwell', 3, 5, '9780451524935', 6),
        ('OPEN', 1, 7,'To Kill a Mockingbird', 'Harper Lee', 4, 7, '9780061120084', 7),
        ('OPEN', 1, 8,'Pride and Prejudice', 'Jane Austen', null, 3, '9781503290563', 8),
        ('OPEN', 1, 9,'The Great Gatsby', 'F. Scott Fitzgerald', 4, 4, '9780743273565', 9),
        ('OPEN', 1, 10,'Moby Dick', 'Herman Melville', null, 2, '9781503280786', 10),
        ('OPEN', 1, 11,'War and Peace', 'Leo Tolstoy', 4, 6, '9780199232765', 11),
        ('OPEN', 1, 12,'The Catcher in the Rye', 'J.D. Salinger', 4, 5, '9780316769488', 12),
        ('OPEN', 1, 13,'The Odyssey', 'Homer', null, 10, '9780140268867', 13),
        ('OPEN', 1, 14,'The Divine Comedy', 'Dante Alighieri', null, 4, '9780142437223', 14),
        ('OPEN', 1, 15,'Jane Eyre', 'Charlotte Brontë', null, 3, '9781503278196', 15),
        ('OPEN', 1, 16,'Wuthering Heights', 'Emily Brontë', 4, 4, '9780141439556', 16),
        ('OPEN', 1, 17,'Brave New World', 'Aldous Huxley', 3, 7, '9780060850524', 17),
        ('OPEN', 1, 18,'Madame Bovary', 'Gustave Flaubert', 4, 5, '9780140449129', 18),
        ('OPEN', 1, 19,'One Hundred Years of Solitude', 'Gabriel Garcia Marquez', null, 8, '9780060883287', 19),
        ('OPEN', 1, 20,'In Search of Lost Time', 'Marcel Proust', null, 2, '9780143039570', 20),
        ('OPEN', 1, 21,'Ulysses', 'James Joyce', null, 3, '9780199535675', 21),
        ('OPEN', 1, 22,'Don Quixote', 'Miguel de Cervantes', null, 7, '9780060934347', 22),
        ('OPEN', 1, 23,'The Iliad', 'Homer', null, 5, '9780140275360', 23),
        ('OPEN', 1, 24,'The Hobbit', 'J.R.R. Tolkien', null, 9, '9780345339683', 24),
        ('OPEN', 1, 25,'Fahrenheit 451', 'Ray Bradbury', 3, 4, '9781451673319', 25);
...
values (1, 'William', 'Shakespeare',
       ...
       (4, 'George', 'Orwell',
        ...
        awareness of social injustice, opposition to totalitarianism, and outspoken support of democratic socialism.'),
       (5, ' Virginia ', ' Woolf ',
